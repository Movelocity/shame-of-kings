...
练习场桌面端默认热键（详见 [`docs/DEV.md` §8.1](./docs/DEV.md#81-桌面端操作练习场)）：
...
| [`openspec/changes/arthur-four-skill-kit/`](./openspec/changes/arthur-four-skill-kit/) | **当前 active change**：亚瑟四技能模版 + 机制重做 |
